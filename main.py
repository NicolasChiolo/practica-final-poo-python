...
def registrar_venta(clientes,inventario):
    ...
    while True:
        nombre_producto = input("Nombre del producto (deje vacío para finalizar): ").strip().lower()
...
def mostrar_menu(): # Este es el menu donde se elegiran las distintas opciones
...
def main(): 
    ...
    while True:
        ...
        if opcion == "1":
            ...
            producto = registrar_venta(clientes, inventario)
        elif opcion == "5":
            ...
            print("¡Saliendo del sistema Patas Felices APP!")
            break
        else:
